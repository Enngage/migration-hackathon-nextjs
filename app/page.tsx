	...
	return (
		<>
			...
			<section
				...
				style={{
					backgroundImage:
						"url('https://images.ctfassets.net/zaag2ctpa60k/gJArMceFvS7Jd3pjvVfdO/7c56382bb6fa0d4630df470c00dc271f/AdobeStockoriginal_507755457.jpg')",
				}}
			>
				<div className="max-w-6xl mx-auto px-8 py-24 w-full">
					<div className="max-w-lg">
						...
						<p className="text-xl text-[#414D63] font-light leading-relaxed mb-8">
							Coin cards offer great rates, personalized services, and exclusive perks helping you manage your money with
							confidence.
						</p>
					</div>
				</div>
				...
				<div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
					...
					<div className="order-1 md:order-2">
						...
						<p className="text-lg text-[#414D63] font-light leading-relaxed">
							With free ATM withdrawals abroad and 24/7 customer service, Coin makes traveling the easiest it&apos;s ever
							been. Upgrade your account and join the jet-set crowd.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="bg-[#F4F4F4] py-24">
				<div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
					<div>
						...
						<p className="text-lg text-[#414D63] font-light leading-relaxed">
							Get up to 3% of your cash back whenever you use the Coin card to pay for purchases. There is no limit on rewards
							you can claim and no spending minimum to hit. Cash back rewards do not expire as long as your account is active.
						</p>
					</div>
			...
			<section className="bg-white py-24">
				<div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
					<div className="relative hidden md:block h-96 rounded-2xl overflow-hidden">
						<Image
					...
					<div>
						<blockquote className="text-2xl text-[#1B273A] font-light leading-relaxed mb-8">
							&ldquo;I can&apos;t recommend Coin enough. If you&apos;re tired of having to deal with unfriendly bank staff,
							long lines and ungodly opening hours, this is the bank for you.&rdquo;
						</blockquote>
